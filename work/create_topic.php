...
<?php
  ...
  {
?>
    <br/><p class="stick">Pin button: </p><div class="checkboxFour" ><input type="checkbox" id="checkboxFourInput" name="sticky" value="on"><label for="checkboxFourInput"></label></div>
<?php
  }
?>
...
<input type="submit" name="Submit" value="Publish immediately" class="button">
